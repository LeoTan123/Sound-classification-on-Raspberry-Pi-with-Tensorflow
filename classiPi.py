...
# Fix 2: Added the following function
...
def extract_features():
    ...
    features = np.empty((0, 161))  # Fix 3: Added this line
...
with tf.Session() as sess:
    ...
    print("Model loaded") # Fix 4: Added brackets
    ...
    while 1:
        ...
        print(y_pred) # Fix 5: Added brackets

        # Fix 6: Added the following to print out the class
        y_pred = np.array(y_pred)
        class_index = most_frequent(y_pred.tolist())
